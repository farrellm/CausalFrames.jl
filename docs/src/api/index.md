...
| [Row transformations](rows.md) | [`filterrows`](@ref "filterrows"), [`addcolumns`](@ref "addcolumns"), [`head`](@ref "head"), [`lastrow`](@ref "lastrow"), [`sortcycles`](@ref "sortcycles"), [`lag`](@ref "lag"), [`Acausal.lead`](@ref "Acausal.lead"), [`settime`](@ref "settime"), [`Acausal.settime`](@ref "Acausal.settime") |
| [Column transformations](columns.md) | [`selectcolumns`](@ref "selectcolumns"), [`dropcolumns`](@ref "dropcolumns"), [`reordercolumns`](@ref "reordercolumns"), [`forwardfill`](@ref "forwardfill"), [`fillmissing`](@ref "fillmissing"), [`asofjoin`](@ref "asofjoin"), [`lookupjoin`](@ref "lookupjoin"), [`Acausal.futurejoin`](@ref "Acausal.futurejoin") |
